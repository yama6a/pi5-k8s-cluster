...
# ---- knobs ------------------------------------------------------------------
STEP=0; STEP_TOTAL=22                          # shared step counter (common.sh step/run_step); bump TOTAL if you add/remove a step
...
# === STEP 22. verify the ingress data path actually serves (best-effort) ======
