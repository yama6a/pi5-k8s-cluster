...
# ---- knobs ------------------------------------------------------------------
STEP=0; STEP_TOTAL=8                            # shared step counter (common.sh step/run_step); bump TOTAL if you add/remove a step
...
# === STEP 8. verify the ingress data path actually serves (best-effort) =======
